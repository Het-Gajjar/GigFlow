...
import type { SubmissionFormValues } from '../../../types/forms'
...
const SubmitWorkModal = ({ isOpen, onClose, task }: SubmitWorkModalProps) => {
  ...
  const {
    ...
    register,
    reset,
  } = useForm<SubmissionFormValues>({ defaultValues: { description: '', fileUrl: '', comments: '' } })
